...
namespace ChaoWorld2.Menu
{
  public class DialogueBox : IMenu
  {
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
      ...
      spriteBatch.Draw(ContentLibrary.Sprites["backgo"], new Vector2(0, Game1.GameHeight - backgo.Height), null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0.00001f);
