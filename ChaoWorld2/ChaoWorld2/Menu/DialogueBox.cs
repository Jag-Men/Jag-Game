...
namespace ChaoWorld2.Menu
{
  public class DialogueBox : IMenu
  {
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
      ...
      var backgo = ContentLibrary.Sprites["backgo"];
      spriteBatch.Draw(ContentLibrary.Sprites["backgo"], new Vector2(0, Game1.GameHeight - backgo.Height), null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, Layer.Menu);
      spriteBatch.Draw(ContentLibrary.Sprites[this.PortraitName], textPos - new Vector2(256, 0), new Rectangle((this.Emotion % 2) * this.PortraitSize, (int)Math.Floor((double)this.Emotion / 2) * this.PortraitSize, this.PortraitSize, this.PortraitSize), Color.White, 0f, Vector2.Zero, 256/this.PortraitSize, SpriteEffects.None, Layer.Menu - 1e-5f);
